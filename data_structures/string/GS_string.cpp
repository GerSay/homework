...
namespace GS {
    ...
    String::String(char c) { m_chars.push_back(c); }
    String::String(const char* cstr) : m_chars(cstr, cstr + std::strlen(cstr)) {}
    String::String(String::ConstIterator from, String::ConstIterator to) : m_chars(from, to) {}
    String::operator std::string() const { return to_std_string(); }
    String::Iterator String::begin() { return m_chars.begin(); }
    String::Iterator String::end() { return m_chars.end(); }
    String::ConstIterator String::begin() const { return m_chars.begin(); }
    String::ConstIterator String::end() const { return m_chars.end(); }
    ...
    vector<String> String::split(char delim, std::size_t expected_splits) const {
    ...
    vector<String> String::split(const String& delim, std::size_t expected_splits) const {
        if (delim.empty())
